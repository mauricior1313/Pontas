object FrmCadastroAnimais: TFrmCadastroAnimais
  Left = 0
  Top = 0
  ...
  object CpnMain: TCardPanel
    ...
    object CrdLista: TCard
      ...
      object Panel1: TPanel
        ...
        object BtnSalvarTudo: TSpeedButton
          AlignWithMargins = True
          Left = 803
          Top = 3
          Width = 38
          ...
          Align = alRight
          ImageIndex = 3
          ImageName = 'CheckBox_16x16'
          Images = VirtualImageList1
          OnClick = BtnSalvarTudoClick
          ExplicitLeft = 287
          ExplicitTop = 5
        end
      end
    ...
    object CrdCadastro: TCard
      ...
      object DbeFazendaId: TDBEdit
        Left = 24
        Top = 43
        Width = 134
        Height = 21
        DataField = 'ANM_FAZENDAID'
        DataSource = Dts
        TabOrder = 0
      end
      ...
      object EdtFazendaRazaoSocial: TEdit
        Left = 187
        Top = 43
        Width = 246
        Height = 21
  ...
  object Qry: TFDQuery
    ...
    SQL.Strings = (
      ...
      '      ,ANM_Ativo'
      '  FROM Animal'
      '  INNER JOIN Fazenda ON ANM_FazendaId = FZN_ID'
      ' WHERE 1=1')
    Left = 272
    Top = 272
    object QryANM_ID: TIntegerField
      FieldName = 'ANM_ID'
      Origin = 'ANM_ID'
      ProviderFlags = [pfInUpdate, pfInWhere, pfInKey]
      Required = True
    end
    object QryANM_FAZENDAID: TIntegerField
      FieldName = 'ANM_FAZENDAID'
      Origin = 'ANM_FAZENDAID'
      Required = True
    end
    object QryANM_NOME: TWideStringField
      FieldName = 'ANM_NOME'
      Origin = 'ANM_NOME'
      Required = True
      Size = 256
    end
    object QryANM_RACA: TWideStringField
      FieldName = 'ANM_RACA'
      Origin = 'ANM_RACA'
      Required = True
      Size = 100
    end
    object QryANM_ATIVO: TWideStringField
      FieldName = 'ANM_ATIVO'
      Origin = 'ANM_ATIVO'
      Required = True
      FixedChar = True
    ...
    object QryANM_TAG: TWideStringField
      FieldName = 'ANM_TAG'
      Origin = 'ANM_TAG'
      Required = True
      Size = 15
